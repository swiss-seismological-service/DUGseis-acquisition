...
class DataToASDF:
    ...
    def data_to_asdf(self, np_data_list):
        ...
        self.stats['starttime_ns'] = self.stats['starttime_ns'] + int((data_points_to_file1 + 1) * (self.stats['delta'] * 10 ** 9))
        self.stats['starttime'] = UTCDateTime(ns=self.stats['starttime_ns'])
        ...
        if data_points_to_file2 != 0:
            ...
            # self.stats['starttime'] = self.stats['starttime'] + self._data_points_in_this_file / self._sampling_rate
            self.stats['starttime_ns'] = self.stats['starttime_ns'] + int((self._data_points_in_this_file + 1) * (self.stats['delta'] * 10 ** 9))
            self.stats['starttime'] = UTCDateTime(ns=self.stats['starttime_ns'])
